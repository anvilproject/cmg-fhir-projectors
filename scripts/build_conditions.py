...
subject_filenames = {
    "uw": {
        "hmb-irb" : "data/uw/hmb-irb/uw_phs000693_hmb-irb_subject_2021-04-22_y9q6.csv",
        "dw-ep" : "data/uw/dw-ep/uw_phs000693_ds-ep_subject_2021-04-22_y9q6.csv",
        "gru-irb": "data/uw/gru-irb/uw_phs000693_gru-irb_subject_2021-04-23_y9q6.csv",
        "ds-bav": "data/uw/ds-bav/uw_phs000693_ds-bav-irb-pub-rd_subject_2021-01-11_y9q5.csv",
        "ds-nbia": "data/uw/ds-nbia/uw_phs000693_ds-nbia_subject_2021-01-13_y9q5.csv",
        "hmb": "data/uw/hmb/uw_phs000693_hmb_subject_2021-02-09_y9q5.csv",
        "gru": "data/uw/gru/gru-subject.csv"
    },
    "y": {
        "ds-mc": "data/yale/ds-mc/Subject_CMG_Yale_phs000744_DS-MC_20201218_Y9Q1.csv",
        "ds-rare": "data/yale/ds-rare/Subject_CMG_Yale_phs000744_DS-RARED_20201202_Y9Q1.csv",
        "hmb": "data/yale/hmb/Subject_CMG_Yale_phs000744_HMB_20201218_Y9Q1.csv",
        "gru": "data/yale/gru/Subject_CMG_Yale_phs000744_GRU_20201218_Y9Q1.csv"
    },
    "bh": {
        "hmb-npu": "data/bh/hmb-npu/hmb-npu-subject.csv.dupes-removed",
                ...
                for hp_content in ["hpo_present", "hpo_absent"]:
                    ...
                    for id in codes:
                        if id not in observed:
                            ...
                            print(f"Skipping duplicate code: {id}")
